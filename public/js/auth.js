    ...
    try {
        ...
        if (roleSelect && roleSelect.value) {
            ...
            if (body.role === 'student') {
                ...
                body.class = classInput ? classInput.value.trim() : '';
            }
        }

        if (window.location.pathname === '/student-login' || window.location.pathname === '/faculty-login' || window.location.pathname === '/login') {
            // On the login page, Google sign-in is for an existing account only.
            // If the user doesn't have an account yet, the backend will tell them to register.
        }
...
if (registerForm) {
    registerForm.addEventListener('submit', async (e) => {
        ...
        if (body.role === 'student') {
            ...
            body.class = document.getElementById('class').value.trim();
        }
